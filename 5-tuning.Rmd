...
Once the value(s) of the parameter(s) are determined, a model can be finalized but fitting the model to the entire training set. 
...
```{r overfitting, echo = FALSE, out.width = '60%', fig.width=9, fig.height=3.75, fig.align='center', dev = 'svg', dev.args = list(bg = "transparent")}
data(parabolic)
