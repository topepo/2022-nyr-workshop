...
Each will produce a separate ROC curves and we will average the  `r nrow(nhl_rs)` areas under those curves to get the resampling estimate of that statistic. 
